...
export const ALL_BENCHMARK_SUITES: BenchmarkSuite[] = [...LEGACY_BENCHMARK_SUITES, ...HOLDOUT_BENCHMARK_SUITES];

export function getBenchmarkCorpusSuites(id: BenchmarkCorpusId): BenchmarkSuite[] {
  return id === 'holdout-550' ? HOLDOUT_BENCHMARK_SUITES : LEGACY_BENCHMARK_SUITES;
}
