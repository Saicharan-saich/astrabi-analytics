        ...
        {!isAuthenticated ? (
          ...
          <div className={getGlobalClasses()} style={getGlobalStyle()}>
                ...
                {isSidebarOpen && (
                  <>
                    ...
                    <motion.div
                      ...
                      className={`app-sidebar qi-sidebar-frame fixed inset-y-0 left-0 z-50 w-[280px] max-w-[85vw] border-r overflow-hidden flex-shrink-0 print:hidden ${theme === 'dark' ? 'bg-[#0c0f16] border-white/[0.06]' : 'bg-white border-gray-200'
                        }`}
                    >
                      <Sidebar
                        activeTab={activeTab}
              ...
              <AnimatePresence>
                {isSidebarOpen && (
                  <motion.div
                    ...
                    className={`app-sidebar qi-sidebar-frame h-full border-r z-20 overflow-hidden flex-shrink-0 relative print:hidden ${theme === 'dark' ? 'bg-[#0c0f16]/90 backdrop-blur-xl border-white/[0.06]' : 'bg-white/90 backdrop-blur-xl border-gray-200'
                      }`}
                  >
                    <Sidebar
                      activeTab={activeTab}
            ...
            <div className="flex-1 flex flex-col min-w-0 overflow-hidden relative">
              {/* Header */}
              <header className={`app-topbar qi-topbar-frame h-14 flex items-center justify-between px-3 md:px-5 z-30 relative border-b print:hidden ${theme === 'dark' ? 'bg-[#12161f]/80 backdrop-blur-xl border-white/[0.06]' : 'bg-white/80 backdrop-blur-xl border-gray-200 shadow-sm'
                }`}>
              ...
              {/* Main Content Area */}
              <main className={`app-main qi-main-frame flex-1 overflow-hidden relative ${theme === 'dark' ? 'bg-[#0a0c12]' : 'bg-[#f4f6fb]'
                }`}>
